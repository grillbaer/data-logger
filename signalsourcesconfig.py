    ...
    'groups' : [
        {'label' : 'Wärmepumpe',
         'sources' : [
            ...
            Ds1820Source('28-000008640446', 1, label='Heizgas',          unit='°C', value_format='{:.1f}', color=[0.8, 0.6, 0.3, 1.0], z_order=-1),
            Ds1820Source('28-0000089a5063', 1, label='Flüssigkeit',      unit='°C', value_format='{:.1f}', color=[0.1, 0.2, 0.4, 1.0], z_order=-1),
            Ds1820Source('28-0000089b1ca2', 1, label='Sauggas',          unit='°C', value_format='{:.1f}', color=[0.4, 0.3, 0.1, 1.0], z_order=-1),
        ]},
        {'label' : 'Heizung',
         'sources' : [
