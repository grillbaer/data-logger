    ...
    'groups' : [
        {'label' : 'Wärmepumpe',
         'sources' : [
            _quelle_ein,
            _quelle_aus,
            DeltaSource(_quelle_ein, _quelle_aus, label='\u0394 Quelle',    unit='K',  value_format='{:.1f}', color=[0.0, 0.0, 0.0, 1.0], with_graph = False, with_history = False),
            _wp_hz_vor,
            DeltaSource(_wp_hz_vor, _wp_rueck,    label='\u0394 Heizung',   unit='K',  value_format='{:.1f}', color=[0.0, 0.0, 0.0, 1.0], with_graph = False, with_history = False),
            _wp_ww_vor,
            DeltaSource(_wp_ww_vor, _wp_rueck,    label='\u0394 Wasser',    unit='K',  value_format='{:.1f}', color=[0.0, 0.0, 0.0, 1.0], with_graph = False, with_history = False),
            _wp_rueck,
        ]},
        {'label' : 'Heizung/Warmwasser',
         'sources' : [
            _hz_vor,
            _hz_rueck,
            DeltaSource(_hz_vor, _hz_rueck,    label='\u0394 Heizung',      unit='K',  value_format='{:.1f}', color=[0.0, 0.0, 0.0, 1.0], with_graph = False, with_history = False),
        ...
        {'label' : 'Lüftung',
         'sources' : [
            _lu_frisch,
            _lu_fort,
            DeltaSource(_lu_fort, _lu_frisch,  label='\u0394 Fort-Frisch',  unit='K',  value_format='{:.1f}', color=[0.0, 0.0, 0.0, 1.0], with_graph = False, with_history = False),
            _lu_zu,
            _lu_ab,
            DeltaSource(_lu_ab, _lu_zu,        label='\u0394 Ab-Zu',        unit='K',  value_format='{:.1f}', color=[0.0, 0.0, 0.0, 1.0], with_graph = False, with_history = False),
