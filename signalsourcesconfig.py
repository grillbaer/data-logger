    ...
    'groups' : [
        {'label' : 'Wärmepumpe',
         'sources' : [
            _quelle_ein,
            _quelle_aus,
            DeltaSource(_quelle_ein, _quelle_aus, label=' Quelle \u0394',   unit='K', value_format='{:.1f}', color=[0.1, 0.1, 0.1, 1.0], with_graph = False, with_history = False),
            _wp_hz_vor,
            DeltaSource(_wp_hz_vor, _wp_rueck,    label=' Heizung \u0394',  unit='K', value_format='{:.1f}', color=[0.1, 0.1, 0.1, 1.0], with_graph = False, with_history = False),
            _wp_ww_vor,
            DeltaSource(_wp_ww_vor, _wp_rueck,    label=' Wasser \u0394',   unit='K', value_format='{:.1f}', color=[0.1, 0.1, 0.1, 1.0], with_graph = False, with_history = False),
            _wp_rueck,
        ]},
        {'label' : 'Heizung/Warmwasser',
         'sources' : [
            _hz_vor,
            _hz_rueck,
            DeltaSource(_hz_vor, _hz_rueck,    label=' Heizung \u0394',     unit='K',  value_format='{:.1f}', color=[0.1, 0.1, 0.1, 1.0], with_graph = False, with_history = False),
        ...
        {'label' : 'Lüftung',
         'sources' : [
            _lu_frisch,
            _lu_fort,
            DeltaSource(_lu_fort, _lu_frisch,  label=' Fort-Frisch \u0394', unit='K', value_format='{:.1f}', color=[0.1, 0.1, 0.1, 1.0], with_graph = False, with_history = False),
            _lu_zu,
            _lu_ab,
            DeltaSource(_lu_ab, _lu_zu,        label=' Ab-Zu \u0394',       unit='K', value_format='{:.1f}', color=[0.1, 0.1, 0.1, 1.0], with_graph = False, with_history = False),
