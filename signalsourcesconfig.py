...
signal_sources_config = {
    'groups' : [
        {'label' : 'Wärmepumpe',
         'sources' : [
            Ds1820Source('28-0000089b1ca2', 1, label='Quelle ein',       unit='°C', value_format='{:.1f}', color=[0.5, 0.5, 1.0, 1.0], z_order=1),
            Ds1820Source('28-000008640446', 1, label='Quelle aus',       unit='°C', value_format='{:.1f}', color=[0.0, 0.2, 1.0, 1.0], z_order=2),
            Ds1820Source('10-000801dd3c70', 1, label='Heizung Vorlauf',  unit='°C', value_format='{:.1f}', color=[1.0, 0.0, 0.0, 1.0], z_order=2),
            TsicSource(pigpio_pi, 26,          label='WW Vorlauf',       unit='°C', value_format='{:.1f}', color=[0.2, 0.3, 0.9, 1.0], z_order=0),
            TsicSource(pigpio_pi, 12,          label='Rücklauf',         unit='°C', value_format='{:.1f}', color=[0.5, 0.1, 0.7, 1.0], z_order=1),
        ]},
